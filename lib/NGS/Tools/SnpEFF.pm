...
A Perl Moose class for handling the snpEFF annotation tool.

THIS CLASS SHOULD NOT BE DIRECTLY USED.  INSTEAD USE THE ROLES
PROVIDED TO BUILD A NEW CLASS.

  use NGS::Tools::SnpEFF;

  my  = NGS::Tools::SnpEFF->new();
